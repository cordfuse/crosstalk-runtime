...
printf "  1. Run setup with your transport repo:\n"
printf "       sudo crosstalk install <git-url>\n"
printf "  2. Add the printed SSH key as a deploy key on your transport repo\n"
printf "  3. Add a workspace:\n"
printf "       sudo crosstalk add-workspace <git-url>\n"
printf "  4. Open a session:\n"
printf "       crosstalk with\n\n"
